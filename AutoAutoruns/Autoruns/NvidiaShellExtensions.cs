...
namespace AutoAutoruns.Autoruns {
    ...
    public abstract class NvidiaShellExtensions: RegistryAutorun {
        ...
        protected override (RegistryKey hive, string path, string? name) registryLocation => (hive: Registry.LocalMachine,
            path: @"SOFTWARE\Microsoft\Windows\CurrentVersion\Shell Extensions\Approved", name: registryName);
